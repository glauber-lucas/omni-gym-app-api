      ...
      <header className="sticky top-0 z-30 border-b border-white/70 bg-white/90 backdrop-blur xl:hidden">
        <div className="flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="Omni Gym Aluno" className="h-10 w-10 object-contain" />
            <span className="font-semibold">Omni Gym Aluno</span>
          </div>
      ...
      >
        <div className="flex h-full flex-col">
          <div className="mb-8 flex items-center gap-3">
            <img src="/logo.png" alt="Omni Gym Aluno" className="h-14 w-14 object-contain" />
            <div>
              <p className="text-sm font-semibold text-primary-100">Portal do aluno</p>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  cx(
                    ...
                    isActive
                      ? 'bg-primary-10 text-primary-100 shadow-sm'
