...
const variants = {
  ...
  ghost:
    'border border-slate-200/80 bg-white/90 text-ink-60 shadow-sm hover:-translate-y-0.5 hover:border-primary-60 hover:text-primary-100 hover:shadow-card focus:ring-primary-20',
  danger:
