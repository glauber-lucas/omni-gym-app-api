...
const variants = {
  primary: 'bg-primary-100 text-white hover:bg-primary-80 focus:ring-primary-20',
  secondary: 'bg-secondary-100 text-slate-950 hover:bg-secondary-80 focus:ring-secondary-20',
  ghost: 'border border-slate-200 bg-white text-slate-700 hover:border-primary-60 hover:text-primary-100 focus:ring-primary-20',
