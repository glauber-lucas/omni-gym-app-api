...
public class AuthenticationController {
    ...
    public ResponseEntity<?> local(@RequestBody java.util.Map<String, Object> payload) {
        ...
        LoginResponseDTO response = authenticationService.authenticate(new com.example.auth.dto.AuthenticationDTO(identifier, password));

        Long userId = null;
        String documentId = null;
        String email = null;
        try {
            com.example.auth.model.User user = authenticationService.getUserByUsername(identifier);
            userId = user.getId();
    ...
    public ResponseEntity<LoginResponseDTO> login(@RequestBody java.util.Map<String, Object> payload) {
        ...
        return ResponseEntity.ok(authenticationService.authenticate(new com.example.auth.dto.AuthenticationDTO(identifier, password)));
    }
    ...
    public ResponseEntity<?> refreshToken(@Valid @RequestBody RefreshTokenDTO dto) {
        ...
        com.example.auth.model.User user = authenticationService.getUserByUsername(username);
